...
const tablerow = tv({
  slots: {
    ...
    fromtodiv:
      "flex flex-grow justify-center items-center border-r-2 border-gray-200 font-semibold text-sm pl-1 pr-2 py-1",
    fromdiv: "text-left border-b py-0.5",
    todiv: "text-left border-t py-0.5",
    costdiv:
      "flex-grow align-middle font-bold text-green-600 text-md text-center px-1",
